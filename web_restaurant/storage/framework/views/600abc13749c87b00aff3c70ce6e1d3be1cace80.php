        ...
        <div class="relative flex items-top justify-center bg-gray-100 focus:bg-black sm:items-center py-4 sm:pt-0">
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(url('/addRes')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Add Restaurant</a>
                        <a href="<?php echo e(route('login')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>
...
<?php /**PATH C:\xampp\htdocs\302CEM_Agile_Laravel\web_restaurant\resources\views/welcome.blade.php ENDPATH**/ ?>